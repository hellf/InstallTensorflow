...
# model.ckpt-1000 파일의 variable을 불러옴.
saver.restore(sess, './log/model.ckpt-1000')
# 윗 line을 comment하고 아랫 line을 uncomment하면 가장 최근 파일의 variable을 불러옴.
...
print("test accuracy %g at step=0"%(test_accuracy/1000))
